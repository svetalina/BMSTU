function lab05
  ...
  plot_figure(0, t, x0, x1, x2, 'Исходные сигналы')
  plot_figure(1, t, x0, x1 - filtfilt(G, 1, x1), x2 - filtfilt(G, 1, x2), 'Фильтр Гаусса')
  plot_figure(2, t, x0, x1 - filtfilt(B, 1, x1), x2 - filtfilt(B, 1, x2), 'Фильтр Баттеруорта')
  end
