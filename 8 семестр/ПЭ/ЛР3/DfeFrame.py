...
class DfeFrame(tk.Frame): 
    def __init__(self, master): 
        ...
        label = tk.Label(self,text="ДФЭ", bg=color1)
        label.grid(row=0)
        ...
        lin_label = tk.Label(  self.formula_frame, text="Линейная модель: ", bg=color1)
        lin_label.grid(row=0, column=0, sticky="e")
        lin_formula_label = tk.Label(self.formula_frame, textvariable=self.lin_formula, bg=color1)
        lin_formula_label.grid(row=0, column=1, sticky="w")

        not_lin_label = tk.Label(self.formula_frame, text="Частично нелинейная модель: ", bg=color1)
        not_lin_label.grid(row=1, column=0, sticky="e")
        not_lin_formula_label = tk.Label(self.formula_frame, textvariable=self.not_lin_formula, bg=color1)
