...
namespace CGRender.GameLogic
{
    public class Scene
    {
        ...
        private List<Color> randomColors = new List<Color> { Color.Green, Color.SpringGreen, Color.OliveDrab };
        ...
        public void Render()
        {
            ...
            float aspect = _device._renderWidth / (float)_device._renderHeight;
            ...
            _device.Render(Camera.Position, Camera.ViewMatrix(), Matrix.PerspectiveFovLH(0.78f, aspect, 0.1f, 1.0f), _meshes, LightPosition, Color4.Lerp(Color.Red, Color.Blue, Angle / 360), true);
