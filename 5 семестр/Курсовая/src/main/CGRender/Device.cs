...
namespace CGRender.Core
{
    public class Device
    {
        ...
        private readonly Mesh[] _objectBuffer;
            ...
            foreach (Mesh mesh in _meshes)
            {
                ...
                for (int i = 0; i < mesh.Faces.Length; i++)
                {
                    ...
                    DrawTriangle(pixelA, pixelB, pixelC, face.Color,
                        Vector3.TransformCoordinate(face.Normal, worldMatrix), lightPosition, cameraPos);
        ...
        public void DrawTriangle(Vertex v1, Vertex v2, Vertex v3, Color4 color, Vector3 vnFace, Vector3 lightPos, Vector3 cameraPos)
        {
            ...
            //float cameraNDotL = ComputeNDotL(centerPoint, vnFace, cameraPos);
